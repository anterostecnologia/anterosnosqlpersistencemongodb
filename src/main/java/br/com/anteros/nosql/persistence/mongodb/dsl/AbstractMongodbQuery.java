 ...
 */
package br.com.anteros.nosql.persistence.mongodb.dsl;
...
public abstract class AbstractMongodbQuery<K, Q extends AbstractMongodbQuery<K, Q>> implements SimpleQuery<Q>, Fetchable<K> {
    ...
    protected DBCursor createCursor(DBCollection collection, Predicate where, Expression<?> projection,
    ...
    private DBObject createQuery(Predicate predicate) {
        if (predicate != null) {
